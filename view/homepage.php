    ...
    <section class="page-description__info">
        ...
        <ul class="page-description__list">
            ...
            <li>
                ...
                <p class="page-description__item-desc">
                    Здесь видим итоговый результат по всем гонщикам, участвующим в соревновании. Также можем увидеть победителей по каждому заезду, сортируя результаты гонщиков по соответствующей попытке.
                </p>
            </li>
        </ul>        
