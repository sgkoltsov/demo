...
<section class="shop-page__order">
    ...
    <div class="shop-page__wrapper">
        ...
        <form action="/players/confirmChange" method="post" class="custom-form js-order">
            ...
            <fieldset class="custom-form__group">
                ...
                <div class="custom-form__column" style="flex-wrap: unset;">
                    ...
                    <label class="custom-form__input-wrapper" for="name" style="width: 100%;">
                        ...
                        <p class="custom-form__input-label" hidden>Фамилия И.<span class="req">*</span></p>
                    ...
                    <label class="custom-form__input-wrapper" for="city" style="width: 100%;">
                        ...
                        <p class="custom-form__input-label" hidden>Город<span class="req">*</span></p>
                    ...
                    <label class="custom-form__input-wrapper" for="car" style="width: 100%;">
                        ...
                        <p class="custom-form__input-label" hidden>Автомобиль<span class="req">*</span></p>
                    ...
                    <div class="custom-form__input-wrapper" style="width: 100%">
                        <input 
                            ...
                            <?=isset($user['entry']) && $user['entry'] ? 'checked' : ''?>
                        >
